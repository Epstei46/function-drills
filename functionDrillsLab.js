...
//   }
// }
// console.log(emailCheck("    nobody@nobody.com  "))
...
//CODE HERE
// function inAscending (numArray){
//   let ascendingCheck = []
//   for (i = 1; i < numArray.length; i++){
//     if (numArray[i] > numArray[i-1]){   // Checks if each number in the array is greater than the preceding number
//       ascendingCheck.push('pass')
//     } else {
//       ascendingCheck.push('fail')
//     }
//   }
//   console.log(ascendingCheck)
//   return ascendingCheck.includes('fail')
//   /*if fail occurs ANYWHERE in the array, will return true. If it doesn't fail ever, returns false*/
// }
// let arrayIsAscending = !inAscending(sampleArray)    // reverses the Boolean so it is checking how we want it to, true only if 'fail' is not in the array
